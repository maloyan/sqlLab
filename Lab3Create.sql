CREATE TABLE [ADDRESS](
	[address_id] [smallint] IDENTITY(1,1) NOT NULL PRIMARY KEY,
...
CREATE TABLE [CITY](
	[city_id] [smallint] IDENTITY(1,1) NOT NULL PRIMARY KEY,
	[city_name] [varchar](50) NOT NULL,
	[country_id] [smallint] NOT NULL
);

CREATE TABLE [CORRESPONDENT](
	[correspondent_id] [smallint] IDENTITY(1,1) NOT NULL PRIMARY KEY,
...
CREATE TABLE [CORRESPONDENT_VIDEO](
	[correspondent_video_id] [smallint] IDENTITY(1,1) NOT NULL PRIMARY KEY,
...
CREATE TABLE [DANGER](
	[danger_id] [smallint] IDENTITY(1,1) NOT NULL PRIMARY KEY,
	[danger_type] [varchar](50) NOT NULL
);

CREATE TABLE [EVENT](
	[event_id] [smallint] IDENTITY(1,1) NOT NULL PRIMARY KEY,
...
CREATE TABLE [EVENT_TYPE](
	[event_type_id] [smallint] IDENTITY(1,1) NOT NULL PRIMARY KEY,
	[danger_id] [smallint] NULL,
	[type] [varchar](50) NOT NULL
);

CREATE TABLE [INTERVIEWEE](
	[interviewee_id] [smallint] IDENTITY(1,1) NOT NULL PRIMARY KEY,
	[person_id] [smallint] NOT NULL,
	[description] [varchar](1000) NULL
);

CREATE TABLE [OPERATOR](
	[operator_id] [smallint] IDENTITY(1,1) NOT NULL PRIMARY KEY,
	[person_id] [smallint] NOT NULL 
);

CREATE TABLE [PERSON](
	[person_id] [smallint] IDENTITY(1,1) NOT NULL PRIMARY KEY,
...
CREATE TABLE [QUALITY](
	[quality_id] [smallint] IDENTITY(1,1) NOT NULL PRIMARY KEY,
	[quality] [varchar](50) NOT NULL 
);

CREATE TABLE [REPORTAGE](
	[reportage_id] [smallint] IDENTITY(1,1) NOT NULL PRIMARY KEY,
...
CREATE TABLE [SCENE_TYPE](
	[scene_type_id] [smallint] IDENTITY(1,1) NOT NULL PRIMARY KEY,
	[scene] [varchar](50) NOT NULL 
);

CREATE TABLE [TRANSLATION](
	[translation_id] [smallint] IDENTITY(1,1) NOT NULL PRIMARY KEY,
	[text] [varchar](1000) NOT NULL,
	[audio] [varchar](100) NOT NULL 
);

CREATE TABLE [VIDEO](
	[video_id] [smallint] IDENTITY(1,1) NOT NULL PRIMARY KEY,
...
CREATE TABLE [WITNESS_VIDEO](
	[witness_video_id] [smallint] IDENTITY(1, 1) NOT NULL PRIMARY KEY,
	[person_id] [smallint] NOT NULL,
	[reportage_id] [smallint] NOT NULL,
	[video_id] [smallint] NOT NULL
);
...
ALTER TABLE [REPORTAGE]  WITH CHECK 
ADD  CONSTRAINT [FK_REPORTAGE_CORRESPONDENT] FOREIGN KEY([correspondent_id])
REFERENCES [CORRESPONDENT] ([correspondent_id])
